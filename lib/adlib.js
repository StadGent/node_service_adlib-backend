...
Adlib.prototype.run = async function () {
    ...
    if (maxGeneratedAtTime) {
        ...
        try {
            ...
            console.log('Failed to retrieve priref from URI: ' + lastURI)
        }
    ...
    if (lastPriref) {
        console.log("All objects for institution " + this._institution + " from previous run are fetched from Adlib! Now retrieving objects starting from " + lastModifiedDate);
